...
const SideNav = () => {
  return (
    ...
    <div className=' text-white flex flex-col py-3 space-y-2 ml-2'>
        ...
        <NavLink to="/company/Member" className={({isActive})=> isActive? 'bg-darkRed pl-2 py-1 rounded-lg rounded-r-none text-md font-semibold opacity-95': ' hover:bg-black hover:bg-opacity-20 pl-2 py-1 rounded-lg rounded-r-none text-md font-semibold opacity-80 hover:opacity-95'}>Add Members</NavLink>
